...
class SearchLoanAccount extends StatefulWidget {
  SearchLoanAccount(this.where);
  final where;
  static const String id = 'SearchLoanAccount';
  @override
  _SearchLoanAccountState createState() => _SearchLoanAccountState();
}

class _SearchLoanAccountState extends State<SearchLoanAccount> {
  ...
  Future<List<LoanCustomer>> getCustomerByAc() async {
    ...
    final url = Uri.parse(
        'https://sanchay-new.herokuapp.com/api/collector/search/loan');
  ...
  Future<List<LoanCustomer>> getCustomer() async {
    SharedPreferences _prefs = await SharedPreferences.getInstance();
    final url = Uri.parse(
        'https://sanchay-new.herokuapp.com/api/agents/loan/customers');
        ...
        child: Column(
          children: [
            ...
            _searchAc.text.isEmpty
                ? FutureBuilder<List<LoanCustomer>>(
                    future: getCustomer(),
                    builder: (_, snap) {
                      if (snap.hasError) {
                        ...
                        return ListView.builder(
                            ...
                            itemBuilder: (__, id) {
                              ...
                              return ListTile(
                                ...
                                trailing: Container(
                                  child:
                                      Text('₹ ${snap.data?[id].payableAmount}'),
                                ),
                              );
                            });
                      } else
